...
ax1.plot(data['time'], data['Bx'], color='r', label='Bx')

ax2 = fig.add_subplot(612)
  
ax2.set_ylabel('Y gyro offset')
ax2.set_ylim([-0.0025,0.0025])
ax2.plot(data['time'], data['By'], color='g', label='By')

ax3 = fig.add_subplot(613)
 
ax3.set_ylabel('Z gyro offset')
ax3.set_ylim([-0.0025,0.0025])
ax3.plot(data['time'], data['Bz'], color='b', label='Bz')

ax4 = fig.add_subplot(614)
 
ax4.set_ylabel('Mag offset N')
ax4.set_ylim([-0.4,0.4])
ax4.plot(data['time'], data['Mbn'], color='b', label='Mbn')

ax5 = fig.add_subplot(615)
 
ax5.set_ylabel('Mag offset E')
ax5.set_ylim([-0.4,0.4])
ax5.plot(data['time'], data['Mbe'], color='b', label='Mbe')
...
ax6.plot(data['time'], data['Mbd'], color='b', label='Mbd')
